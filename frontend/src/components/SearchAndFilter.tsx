        ...
        <div className="flex items-center space-x-4 mb-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-lg text-gray-900 bg-white placeholder-gray-500"
            />
          </div>
          <button
